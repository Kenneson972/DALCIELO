      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
            ...
            <div className="absolute -bottom-10 -left-10 glass p-8 rounded-3xl shadow-xl hidden md:block">
              ...
              <p className="text-sm font-bold uppercase tracking-widest text-gray-text">Année de création</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black mb-4">Nos <span className="text-primary">Valeurs</span></h2>
            <p className="text-gray-text max-w-xl mx-auto">Ce qui nous définit et nous motive chaque jour à allumer le four.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              ...
              >
                <Card className="p-10 h-full text-center hover:border-primary/20 border-2 border-transparent transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
          ...
          <Card className="p-12 border-2 border-dark overflow-hidden relative group">
